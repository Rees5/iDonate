...
if (isset($_POST["facility"])) {
    $address = !empty($_POST["address"]) ? $_POST["address"] : $_POST["fName"];
    createFacility($_POST["fName"], $_POST["phone"], $_POST["type"], $address, $_POST["city"], $_POST["country"], $_POST["cordinates"], $connect);
}
